...
<div ng-controller="loginLogController">
    <div  class="table-bg">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/res/js/admin/loginLogService.js"></script>
<script>
            app.controller("loginLogController",function($scope,loginLogService){
                $scope.nav.index=1;
                ...
                $scope.initList=function(index) {
                    ...
                    $scope.index = index;
                    loginLogService.initList(index)
