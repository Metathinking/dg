...
<div ng-controller="frontUserArticleController" ng-init="listArticleByUserId(${id},${index})">
    <div class="row" >
    ...
    <div front-pagination-directive page-list="pageList" link="/front/user/articleList/${id}.html" page-count="pageQuery.pageCount" index="index"></div>
</div>
<script type="text/javascript" src="${pageContext.request.contextPath}/res/js/front/frontUserService.js"></script>
<script>
    app.controller("frontUserArticleController",function($scope,frontUserService){
        $scope.userNav.action=1;
        $scope.listArticleByUserId = function(_id,_index){
            $scope.index = _index;
            frontUserService.listArticleByUserId(_id,_index)
